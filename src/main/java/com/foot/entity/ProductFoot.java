...
@Getter
@NoArgsConstructor
@Table(name = "productfoot")
public class ProductFoot extends Timestamped{
    /**
     ...
     */
    @Builder
    public ProductFoot(String footpicture , String predictfootpicture , Long footsize , Long feetsize , Product product){
